<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
    <div class="px-5 pt-5">
        @php
            $k = $kpis['complementos'] ?? ['actual'=>0,'previo'=>0,'delta_pct'=>null,'top_cliente'=>['nombre'=>'','total'=>0]];
            $delta = $k['delta_pct'];
        ...
        <header class="flex justify-between items-start mb-2">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Complementos de pago</h2>
        </header>
